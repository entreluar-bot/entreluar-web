  ...
  return (
    <div className="min-h-screen bg-[var(--color-wine-dark)] flex flex-col font-sans">
      <main className="flex-1 max-w-3xl w-full mx-auto p-8 relative z-10 pt-16">
        <div className="mb-12">
          <Link href="/resenhas" className="text-[var(--color-gold)] hover:text-white transition-colors text-xs md:text-sm uppercase tracking-widest font-bold">
            &larr; Voltar para as Resenhas
          </Link>
        </div>
