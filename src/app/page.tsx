      ...
      <div className="content-wrap">
        <section className="hero">
          <div className="hero-copy">
            ...
            <p className="hero-intro">Eu testo os potinhos, estudo a pele e conto tudo como é — inclusive o que não vale o boleto. 🍷</p>
            <nav className="home-portals" aria-label="Escolha por onde começar">
              ...
              <HomePortal href={newReview ? `/resenhas/${newReview.id}` : "/resenhas"} title="Te Explico" subtitle="Ciência sem jaleco" isNew={Boolean(newReview)} />
            </nav>
          </div>
